 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'viewModels/dashboard', 'ojs/ojlabel',
        'ojs/ojinputtext', 'ojs/ojbutton', 'ojs/ojrouter', 'data/globData'],
    function (oj, ko, $, app, dash) {

        function LoginViewModel() {
            var self = this;
            self.username = ko.observable("user2");
